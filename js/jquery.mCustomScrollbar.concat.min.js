    ...
    (ne = 'function' == typeof define && define.amd),
        ...
        (I = function () {
            var t,
                ...
                g = l.advanced.extraDraggableSelectors
                    ...
                    if (!(u - d > 30)) {
                        ...
                        (m =
                            'yx' === w.axis
                                ...
                                : [k[0], null]),
                            (p = [
                                4 * y[0] + w.scrollInertia,
                                4 * y[1] + w.scrollInertia,
                            ]);
                        ...
                        e(this).bind('load', function () {
                            A(this) &&
                                e(
                                    this.contentDocument ||
                                        this.contentWindow.document
                                ).bind('mousewheel.' + i, function (e, t) {
                                    d(e, t);
                                });
                        });
                    }),
            ...
            function d(a, i) {
                if ((V(t), !z(t, a.target))) {
                    ...
                    ('y' === u && !o.overflowed[0]) ||
                        ('x' === u && !o.overflowed[1]) ||
                        ((n.mouseWheel.invert ||
                            a.webkitDirectionInvertedFromDevice) &&
                            (v = -v),
            ...
            s.bind(
                ...
                .bind('click.' + i, function (a) {
                    if (
                        ...
                        if (
                            i.parent('.mCSB_scrollTools_horizontal').length > 0
                        ) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    var f = 'x',
                                        h =
                                            Math.abs(s[0].offsetLeft) -
                                            u * (0.9 * c.width());
                                else
                                    var f = 'y',
                                        h =
                                            Math.abs(s[0].offsetTop) -
                                            u * (0.9 * c.height());
                                Q(t, h.toString(), {
                                    dir: f,
                                    scrollEasing: 'mcsEaseInOut',
        ...
        (N = function (t) {
            ...
            if (t)
                return (
                    clearTimeout(r[0].autoUpdate), void Z(r[0], 'autoUpdate')
                );
            function l(e) {
        ...
        (Q = function (t, o, n) {
            ...
            if (
                ...
                '_resetY' !== o ||
                    i.contentReset.y ||
                    (M('onOverflowYNone') &&
                        r.callbacks.onOverflowYNone.call(t[0]),
                    (i.contentReset.y = 1)),
                '_resetX' !== o ||
                    i.contentReset.x ||
                    (M('onOverflowXNone') &&
                        r.callbacks.onOverflowXNone.call(t[0]),
                    (i.contentReset.x = 1)),
                '_resetY' !== o && '_resetX' !== o)
            ) {
                if (
                ...
                b[1] < 0 || (0 === b[0] && 0 === b[1])
                    ...
                    : (b[0] = -b[0]),
                    t[0].mcs ||
                        (O(), M('onInit') && r.callbacks.onInit.call(t[0])),
                            ...
                            n.overwrite,
                            {
                                onStart: function () {
                                    n.callbacks &&
                                        ...
                                        (M('onScrollStart') &&
                                            (O(),
                                            r.callbacks.onScrollStart.call(
                                                t[0]
                                            )),
                                        (i.tweenRunning = !0),
                                        C(x),
                                        (i.cbOffsets = [
                                            r.callbacks.alwaysTriggerOffsets ||
                                                w >= S[0] + y,
                                            r.callbacks.alwaysTriggerOffsets ||
                                                w <= -B,
                                        ]));
                                ...
                                onComplete: function () {
                                    if (n.callbacks && n.onComplete) {
                                        'yx' === r.axis &&
                                            clearTimeout(
                                                d[0].onCompleteTimeout
                                            );
                                        var e = d[0].idleTimer || 0;
                                        d[0].onCompleteTimeout = setTimeout(
                                            function () {
                                                M('onScroll') &&
                                                    (O(),
                                                    r.callbacks.onScroll.call(
                                                        t[0]
                                                    )),
                                                    M('onTotalScroll') &&
                                                        b[1] >= S[1] - T &&
                                                        i.cbOffsets[0] &&
                                                        (O(),
                                                        r.callbacks.onTotalScroll.call(
                                                            t[0]
                                                        )),
                                                    M('onTotalScrollBack') &&
                                                        b[1] <= k &&
                                                        i.cbOffsets[1] &&
                                                        (O(),
                                                        r.callbacks.onTotalScrollBack.call(
                                                            t[0]
                                                        )),
                                                    (i.tweenRunning = !1),
                                                    (d[0].idleTimer = 0),
            ...
            function M(e) {
                return (
                    i && r.callbacks[e] && 'function' == typeof r.callbacks[e]
                );
            }
            function O() {
                    ...
                    mcsInView:
                        ...
                        function (t) {
                            ...
                            if (i.length)
                                return (
                                    (o = i.parent()),
                                    (a = [i[0].offsetTop, i[0].offsetLeft])[0] +
                                        oe(n)[0] >=
                                        0 &&
                                        a[0] + oe(n)[0] <
